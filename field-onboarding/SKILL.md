...
gloss so they can tell what each item means. In omp, render it with one
`ask` call — one question per prerequisite, each offering `used it`,
`learned it`, and `new`. Fall back to a plain table only when `ask` is
unavailable. Printing marks the user has to type back when
...
[references/unsettled-fields.md](skill://field-onboarding/references/unsettled-fields.md) before Rung 1
...
rung. Load [references/pacing.md](skill://field-onboarding/references/pacing.md) before Rung 1 for the
...
Load [references/citations.md](skill://field-onboarding/references/citations.md) before producing a
...
Load [references/checkpoints.md](skill://field-onboarding/references/checkpoints.md) for the question
...
[references/decode-mode.md](skill://field-onboarding/references/decode-mode.md) and follow it: gist,
...
| File | Load it when |
| --- | --- |
| [references/pacing.md](skill://field-onboarding/references/pacing.md) | Before Rung 1, once the target is known |
| [references/unsettled-fields.md](skill://field-onboarding/references/unsettled-fields.md) | The field is emerging, contested, or beyond you |
| [references/citations.md](skill://field-onboarding/references/citations.md) | You are about to name a specific work |
| [references/search-recipes.md](skill://field-onboarding/references/search-recipes.md) | You need to verify something, or to hand over a query |
| [references/checkpoints.md](skill://field-onboarding/references/checkpoints.md) | Before the first checkpoint |
| [references/decode-mode.md](skill://field-onboarding/references/decode-mode.md) | The user supplied text instead of a field |
| [references/anti-patterns.md](skill://field-onboarding/references/anti-patterns.md) | Reviewing your own output |
| [references/examples.md](skill://field-onboarding/references/examples.md) | An example would settle how a rule applies |

## Behavioral examples

For representative first responses, negative triggers, checkpoint branching,
source-fidelity handling, and reading-path labelling, consult
[references/examples.md](skill://field-onboarding/references/examples.md) when an example would
...
recently. In omp, that is `web_search`, plus `read` for the open-API query endpoints below. When you do not, hand the reader the query instead of a guess.

[references/search-recipes.md](skill://field-onboarding/references/search-recipes.md) has the query
...
The full list is in
[references/anti-patterns.md](skill://field-onboarding/references/anti-patterns.md). The three that
